function [data_sp,data_tu]=my_cell_location_ph_hunter(vidFrames,...
...
for i = 1 : Nframes
    ...
    if exist('c_tu_int_c', 'var') && not(isempty(c_tu_int_c))
        ...
        c_tu_c=[c_tu_int_c(1,1) c_tu_int_c(1,2)];
    end
    ...
    if exist('c_tu_int', 'var') && not(isempty(c_tu_int))
        c_tu_int=[c_tu_int(:,1) c_tu_int(:,2)];
    end
    c_tu=[c_tu_int];
  
    if exist('r_tu_int', 'var') && not(isempty(r_tu_int))
        r_tu = [r_tu_int];
    end
    ...
    if mod(i,400)==0
        ...
        hold on;
        if exist('c_tu_c', 'var') && not(isempty(c_tu_c))
            viscircles(c_tu_c,r_tu_c,'EdgeColor','b');
        end
        if exist('cancelled_sp', 'var')
    ...
    clear Ib2_sp roi...
        ...
        mask mask2 Ib3_sp c_sp r_sp...
        dist_sp cancelled_sp cancelled_r_sp
end
