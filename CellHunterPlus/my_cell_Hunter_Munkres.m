...
function [track_tu, track_sp] = my_cell_Hunter_Munkres(vidFrames,...
    path_temp)
% load parameters
...
% Cell)
[p_tu,q_tu]=my_link_data_Munkres(data_tu,Rmax_tu,DP_tu);
% Tracks' filtering for the MCC
[track_tu,~]=my_track_refining(p_tu,q_tu, 0, 0,'tu');

% Tracking algorithm and filtering for immune cells
if flag_imm
    [p_sp,q_sp]=my_link_data_Munkres(data_sp,Rmax_sp,DP_sp);
    [p_sp3,q_sp3]=my_track_refining(p_sp,q_sp,r_std,L_sp,'sp');
