...
-   **Matlab R2022b** is installed with the additional toolboxes **"Image Processing Toolbox"** and **"Statistics and Machine Learning Toolbox"**. (needed for the CellHunterPlus module)\
