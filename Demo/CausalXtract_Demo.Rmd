...
-   the **MATLAB_DATA.rar** file from [*https://doi.org/10.5281/zenodo.7755700*](https://doi.org/10.5281/zenodo.7755700){.uri} has been downloaded\
    and extracted in the **CausalXtract/MATLAB_DATA** folder. The **ROI MAT.rar** and **ROI_TU MAT.rar** files have to be extracted as well inside the MATLAB_DATA folder.
...
```{r}
library (miic)
data <- read.table ("../results/tables/input_tMIIC.csv", 
                    sep=",", header=T)
